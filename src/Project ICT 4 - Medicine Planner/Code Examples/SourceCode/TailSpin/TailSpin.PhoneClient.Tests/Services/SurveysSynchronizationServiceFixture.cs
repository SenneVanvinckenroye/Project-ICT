...
using TailSpin.PhoneClient.Tests.Services.Mocks;
...
namespace TailSpin.PhoneClient.Tests.Services
{
    ...
    public class SurveysSynchronizationServiceFixture
    {
        ...
        public void StartSynchronizationCallsGetNewSurveys()
        {
            ...
            var syncService = 
                new SurveysSynchronizationService(() => surveysServiceClientMock, 
                                                  new SurveyStoreLocatorMock(new SurveyStoreMock()));
        ...
        public void StartSynchronizationCallsGetNewSurveysWithLastSyncDate()
        {
            ...
            var syncService = 
                new SurveysSynchronizationService(() => surveysServiceClientMock,
                                                  new SurveyStoreLocatorMock(surveyStoreMock));
