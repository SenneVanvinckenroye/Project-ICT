...
namespace TailSpin.Web.Survey.Shared.Models
{
    ...
    public class SurveyAnswersSummary
    {
        ...
        public List<QuestionAnswersSummary> QuestionAnswersSummaries { get; set; }
            ...
            foreach (var questionAnswer in surveyAnswer.QuestionAnswers)
            {
                ...
                switch (questionAnswer.QuestionType)
                {
                    case QuestionType.SimpleText:
                        ...
                        var stemmedWords = 
                            words.Where(w => !WordCloudFiltering.IsStopWord(w))
                                 .Select(w => System.Text.RegularExpressions.Regex.Replace(w, @"[^a-z0-9]", string.Empty, System.Text.RegularExpressions.RegexOptions.IgnoreCase))
                    ...
                    case QuestionType.Picture:
                        questionAnswersSummary.AnswersSummary = questionAnswer.Answer;
                        break;
